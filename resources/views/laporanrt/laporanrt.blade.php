...
<div class="row">
  <div class="col-xl-4 col-lg-5">
    <div class="card text-white bg-primary mb-3" style="width: 18rem; margin">
      ...
      <br> <br>
      <a href="pemasukan_rt" class="btn btn-primary stretched-link">
  ...
  <div class="col-xl-4 col-lg-5">
    <div class="card text-white bg-success mb-3" style="width: 18rem; margin">
      ...
      <br> <br>
      <a href="/pengeluaran_rt" class="btn btn-success stretched-link">
        <i data-feather="arrow-right-circle"></i>
  ...
  <div class="col-xl-4 col-lg-5">
    <div class="card text-white bg-info mb-3" style="width: 18rem; margin">
      ...
      <br> <br> <br>
      <a href="laporan_keuangan_rt" class="btn btn-info text-white stretched-link">
        <i data-feather="arrow-right-circle"></i>
