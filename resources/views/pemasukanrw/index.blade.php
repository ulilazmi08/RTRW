    ...
    <div class="card">
        ...
        <div class="card-body">   
          <div class="row">
            ...
            <div class="col">
              <a class="btn btn-success" href="{{ route('export-pemasukan') }}">Simpan Sebagai Excel</a>
            </div>
            <div class="col">
              <a class="btn btn-info" href="{{ route('export-pemasukan-pdf') }}">Simpan Sebagai PDF</a>
            </div>
          </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="/simpan_pemasukan_rw" class="mb-5" enctype="multipart/form-data" >
                @csrf
              <div class="mb-3">
                <div class="md-3">
                  Nominal
          ...
          @include('pemasukanrw.table', $laporans)
          {{$laporans->links()}}
        </div>
      </div>
