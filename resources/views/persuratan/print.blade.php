            ...
            <center>
                <table style=" text-indent: 10px;" table-responsive width="75%" >
                    <tbody>
                        ...
                        @if ($surat_pengirim->jenis_surat == "Surat Pengantar Domisili" || $surat_pengirim->jenis_surat == "Surat Pengantar Domisili Sementara" )
                        <tr>
                            <td>Alamat Asal</td>
                            <td>:</td>
                            <td>{{ $surat_pengirim->alamat_asal_pengirim }} No.{{$surat_pengirim->no_rumah_asal_pengirim}}</td>
                        </tr> 
                        @else
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
                            <td>{{ $surat_pengirim->alamat_pengirim }} No.{{$surat_pengirim->no_rumah_pengirim}}</td>
                        </tr>
                        @endif
            ...
            <div>
				...
				<div class="col" style="float: right; width: 45%; height: 80%;">
                    <p style="text-align: right">
                        ...
                        <br>
                        <br>
                        <img class="ttd" src="{{public_path('public/Parafrt/'. $parafrt)}}" width="87px" height="100px">
                        <br>
                        <br>
                        <u>{{ $ketuart }}</u>
                    </p>
