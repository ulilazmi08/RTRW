    ...
    <div class="body">
        <div class="container" style="width:100%;height: 842px; ">
            {{-- <table style=" text-indent: 10px;" table-responsive width="75%" >
                <tbody>
                <tr>
                    <td width="5%">Kecamatan</td>
                    <td width="1%">:</td>
                    <td width="10%">Johar Baru</td>
                </tr>
                </tbody>
            </table> --}}
            <p style="text-indent: 20px; text-align: left">Kecamatan   : Johar Baru</p>
            <p style=" text-indent: 20px; text-align: left">Kelurahan   : Galur</p>
            ...
            <div>
                    ...
                    <p style="text-align: left">
                        ...
                        <table class="kopsurat">
                            <thead style="width:5cm; height:1cm; ">
                              <tr>
                                <th style=" font-size:25px" scope="col">RW.06/3</th>
				...
				<div class="col" style="float: right; width: 45%; height: 80%;">
                    <p style="text-align: right">
                        Jakarta, {{ $waktu }}<br>
                        <b>Pengurus RT. {{ $surat_pengirim->rt_pengirim }} / RW. 06</b>
                        <br>
                        <br>
                        <br>
                        <br>
