...
<div class="row">
    <div class="col-xl-4 col-lg-5 mt-5">
        <div class="card" >
            <div id="chartGender" style="height: 300px; width: 85%;" class="card-body">
    ...
    <div class="col-xl-4 col-lg-5 mt-5">
        <div class="card" >
            <div id="chartPendidikan" style="height: 300px; width: 85%;" class="card-body">
                <table class="table mt-4">
                    <tbody>
                    </tbody>
                </table>
    ...
    <div class="col-xl-4 col-lg-5 mt-5">
        <div class="card" >
            <div id="chartAgama" style="height: 300px; width: 85%;" class="card-body">
                <table class="table mt-4">
                    <tbody>
                    </tbody>
                </table>
...
<div class="row mt-5">
    <div class="col-xl-6 col-lg-5 mt-5">
        <div class="card" >
    ...
    window.onload = function () {
        ...
        var chart = new CanvasJS.Chart("chartPendidikan", {
            ...
            data: [              
            {
                ...
                type: "column",
                dataPoints: [
                    { label: "Belum Sekolah",  y: belumsekolah  },
                    { label: "SD",  y: sd  },
                    { label: "SMP", y: smp  },
                    { label: "SMA", y: sma  },
                    { label: "S1", y: s1  },
