      ...
      <div class="card mt-5">
        ...
        <div class="card-body">
            <div class="row">
              ...
              @endif
              @if( Gate::check('bendahara') || Gate::check('admin') )
              <div class="col-md-3 text-center">
          ...
          @endif
                ...
                @endif
                @if (Gate::check('ketuart') || Gate::check('sekretarisrw') || Gate::check('ketuarw') || Gate::check('admin'))
