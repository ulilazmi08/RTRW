...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
          @foreach ($users as $user)
                  @foreach ($profils as $profil)
                    <form method="POST" action="/updatewargaasrw/{{$user->id}}" class="mb-5" enctype="multipart/form-data">
                              {{-- @method('PUT') --}}
                              @csrf
                              <div class="mb-3">
        ...
        <div class="card-body">
          @foreach ($users as $user)
                  @foreach ($profils as $profil)
                    <form method="POST" action="/updatewarga/{{$user->id}}" class="mb-5" enctype="multipart/form-data">
                              {{-- @method('PUT') --}}
                              @csrf
                              <div class="mb-3">
                                <label for="name" class="form-label">Nama</label>
