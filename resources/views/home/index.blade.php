...
@section('container')
    <div class="row">
        ...
        <div class="card mt-5">
            <div class="card-header">
                <h1 class="h2">
            <img class="logo" src="{{asset('public/Logo/'. $logo)}}" width="87px" height="100px">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @foreach ($profils as $profil)
                                                    ...
                                                    <input type="hidden" id="alamat_pengirim" name="alamat_pengirim"
                                                        value="{{ $profil->alamat }}">
                                                    <input type="hidden" id="alamat_asal_pengirim" name="alamat_asal_pengirim"
                                                        value="{{ $profil->alamat_asal }}">
                                                          <input type="hidden" id="no_rumah_pengirim" name="no_rumah_pengirim"
                                                        value="{{ $profil->no_rumah }}">
                                                        <input type="hidden" id="no_rumah_asal_pengirim" name="no_rumah_asal_pengirim"
                                                        value="{{ $profil->no_rumah_asal }}">
