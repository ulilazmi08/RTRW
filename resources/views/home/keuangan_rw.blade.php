      ...
      <div class="card">
          ...
          <div class="card-body">   
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <form method="POST" action="/simpan_keuangan_rw" class="mb-5" enctype="multipart/form-data" >
                      @csrf
                    <div class="mb-3">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <form action="/hapus_laporan/{{$laporankeuangan->id}}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
