              ...
              <tbody>
                <tr >
                  ...
                  <td>
                    ...
                    <form action="/hapusiuran/{{$iuran->id}}" method="post" class="d-inline">
                      @method('delete')
                      @csrf
                      <button value="DELETE" type="button submit" class="d-inline btn btn-danger" onclick="return confirm('Yakin ingin menghapus iuran ini ?')">
                        Hapus Iuran</button>
                    </form>
                  </td>
                </tr>
