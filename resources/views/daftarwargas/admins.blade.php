            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  @endif
                  @if( $role !=7 && $role !=4 && $role !=5 && $role !=3 && $role !=1 && $countbendahararw == 0 )
                ...
                @endif
                @if($role != 8 && $role !=4 && $role !=5 && $role !=3 && $role !=1 && $countsekretarisrw == 0 )
              ...
              @endif --}}
              @if ($role != 6 && $role !=5 &&  $role !=4 && $role !=1 && $role !=3)
